...
directory = "C:/Users/turan/handwrite_recognition/ml_project/csv_files"
...
for csv_file in csv_files:
    ...
    # Convert figures to grayscale
    cmap = 'gray'

    plt.figure()
    plt.pcolormesh(t1, f1, np.abs(Zxx1), cmap=cmap, vmin=0, vmax=signal1.max(), shading='gouraud')
    plt.plot()
    plt.axis("off")
    plt.savefig(f"C:/Users/turan/handwrite_recognition/ml_project/figures4/{file_name}1.png")
    plt.close()

    plt.figure()
    plt.pcolormesh(t2, f2, np.abs(Zxx2), cmap=cmap, vmin=0, vmax=signal2.max(), shading='gouraud')
    plt.plot()
    plt.axis("off")
    plt.savefig(f"C:/Users/turan/handwrite_recognition/ml_project/figures4/{file_name}2.png")
    plt.close()

    plt.figure()
    plt.pcolormesh(t3, f3, np.abs(Zxx3), cmap=cmap, vmin=0, vmax=signal3.max(), shading='gouraud')
    plt.plot()
    plt.axis("off")
    plt.savefig(f"C:/Users/turan/handwrite_recognition/ml_project/figures4/{file_name}3.png")
    plt.close()

    plt.figure()
    plt.pcolormesh(t4, f4, np.abs(Zxx4), cmap=cmap, vmin=0, vmax=signal4.max(), shading='gouraud')
    plt.plot()
    plt.axis("off")
    plt.savefig(f"C:/Users/turan/handwrite_recognition/ml_project/figures4/{file_name}4.png")
    plt.close()
